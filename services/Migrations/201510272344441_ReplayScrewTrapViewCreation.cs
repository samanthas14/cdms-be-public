namespace services.Migrations
{
    ...
    public partial class ReplayScrewTrapViewCreation : DbMigration
    {
...
-- No undo
update fields        set dbcolumnname = 'ClipStatus' where dbColumnName = 'Clip'
update datasetfields set dbcolumnname = 'ClipStatus' where dbColumnName = 'Clip'
update fields        set dbcolumnname = 'TagStatus' where dbColumnName = 'Tag' and fieldcategoryid in (select id from fieldcategories where name in ('Screw Trap', 'Electrofishing'))
update datasetfields set dbcolumnname = 'TagStatus' where fieldid in(select id from fields where fieldcategoryid in (select id from fieldcategories where name in ('Screw Trap', 'Electrofishing'))) and DbColumnName = 'Tag'
