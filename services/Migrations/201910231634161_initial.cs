namespace services.Migrations
{
    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        FeatureImage = c.Int(),
                        DatasetId = c.Int(),
                        SharingLevel = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                ...
                c => new
                    {
                        ...
                        LocationTypeId = c.String(),
                        DefaultConfig = c.String(),
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        MarkSubbasinCode = c.String(),
                        MarkSubbasinSite = c.String(),
                        MarkYear = c.Int(nullable: false),
                        MarkDate = c.DateTime(nullable: false),
                        MarkMethodCode = c.String(),
                        ReleaseSubbasin = c.String(),
                        ReleaseSubbasinSite = c.String(),
                        ReleaseSiteName = c.String(),
                        ...
                        SRRName = c.String(),
                        MarkLength = c.Int(),
                        MarkWeight = c.Decimal(precision: 9, scale: 2),
                        PassageSiteCode = c.String(),
                        PassageSiteName = c.String(),
                        FirstTimeValue = c.DateTime(nullable: false),
                        LastTimeValue = c.DateTime(nullable: false),
                        Count = c.Int(nullable: false),
                        SpeciesCode = c.String(),
                        SpeciesName = c.String(),
                        RunCode = c.String(),
                        RunName = c.String(),
                        RearTypeCode = c.String(),
                        RearTypeName = c.String(),
                        FishMarkToObs = c.Int(nullable: false),
                        DaysBetweenReleaseAndFirstObs = c.Int(nullable: false),
                        MarkDateMax = c.DateTime(nullable: false),
                        ReleaseDateMax = c.DateTime(nullable: false),
                        FirstObjDateMax = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        ...
                        Lifestage = c.String(),
                        SurvivalTo = c.String(),
                        Survival = c.Decimal(precision: 5, scale: 4),
                        StdError = c.Decimal(precision: 5, scale: 4),
                        Lower95 = c.Decimal(precision: 5, scale: 4),
                        Upper95 = c.Decimal(precision: 5, scale: 4),
                        Comments = c.String(),
                        RowId = c.Int(nullable: false),
                        RowStatusId = c.Int(nullable: false),
                        ActivityId = c.Int(nullable: false),
            ...
            CreateTable(
                "dbo.NPT_Sturgeon_Detail",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        PITCode = c.String(),
                        RKM_stream = c.String(),
                        RKM_columbia = c.String(),
                        FloyTag = c.Int(),
                        ForkLength = c.String(),
                ...
                c => new
                    {
                        ...
                        Visibility = c.String(),
                        SurveyComments = c.String(),
                        PreviousRedds = c.Int(nullable: false),
                ...
                c => new
                    {
                        ...
                        MsPollutionTolerant = c.Decimal(precision: 18, scale: 2),
                        MsPredator = c.Decimal(precision: 18, scale: 2),
                        MsDominantTaxa3 = c.Decimal(precision: 18, scale: 2),
                        BIbiScore = c.Int(),
                        RowId = c.Int(nullable: false),
                        RowStatusId = c.Int(nullable: false),
                        ActivityId = c.Int(nullable: false),
                ...
                c => new
                    {
                        ...
                        Species = c.String(),
                        PointData = c.String(),
                        Result = c.Decimal(precision: 9, scale: 4),
                        ResultUnit = c.String(),
                ...
                c => new
                    {
                        ...
                        Result = c.Decimal(precision: 9, scale: 3),
                ...
                c => new
                    {
                        ...
                        HeaderComments = c.String(),
                        FieldsheetLink = c.String(),
                        StrandingIssues = c.String(),
                        StrandingComments = c.String(),
                        ActivityId = c.Int(nullable: false),
                        ByUserId = c.Int(nullable: false),
                        EffDt = c.DateTime(nullable: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.NPT_Sturgeon_Header", "ByUserId", "dbo.Users");
            DropForeignKey("dbo.NPT_Sturgeon_Header", "ActivityId", "dbo.Activities");
            DropForeignKey("dbo.NPT_Sturgeon_Detail", "QAStatusId", "dbo.QAStatus");
            DropForeignKey("dbo.NPT_Sturgeon_Detail", "ByUserId", "dbo.Users");
            DropForeignKey("dbo.NPT_Sturgeon_Detail", "ActivityId", "dbo.Activities");
            ...
            DropForeignKey("dbo.Arrays_Site_Header", "ByUserId", "dbo.Users");
            DropForeignKey("dbo.Arrays_Site_Header", "ActivityId", "dbo.Activities");
            ...
            DropForeignKey("dbo.Arrays_POP_Header", "ByUserId", "dbo.Users");
            DropForeignKey("dbo.Arrays_POP_Header", "ActivityId", "dbo.Activities");
            ...
            DropForeignKey("dbo.Arrays_Efficiency_Header", "ByUserId", "dbo.Users");
            DropForeignKey("dbo.Arrays_Efficiency_Header", "ActivityId", "dbo.Activities");
            DropForeignKey("dbo.Arrays_Efficiency_Detail", "QAStatusId", "dbo.QAStatus");
            DropForeignKey("dbo.Arrays_Efficiency_Detail", "ByUserId", "dbo.Users");
            DropForeignKey("dbo.Arrays_Efficiency_Detail", "ActivityId", "dbo.Activities");
            ...
            DropForeignKey("dbo.Fields", "FieldRoleId", "dbo.FieldRoles");
            DropForeignKey("dbo.Fields", "DatastoreId", "dbo.Datastores");
            ...
            DropIndex("dbo.NPT_Sturgeon_Header", new[] { "ByUserId" });
            DropIndex("dbo.NPT_Sturgeon_Header", new[] { "ActivityId" });
            DropIndex("dbo.NPT_Sturgeon_Detail", new[] { "QAStatusId" });
            DropIndex("dbo.NPT_Sturgeon_Detail", new[] { "ByUserId" });
            DropIndex("dbo.NPT_Sturgeon_Detail", new[] { "ActivityId" });
            ...
            DropIndex("dbo.Arrays_Efficiency_Header", new[] { "ByUserId" });
            DropIndex("dbo.Arrays_Efficiency_Header", new[] { "ActivityId" });
            DropIndex("dbo.Arrays_Efficiency_Detail", new[] { "QAStatusId" });
            DropIndex("dbo.Arrays_Efficiency_Detail", new[] { "ByUserId" });
            DropIndex("dbo.Arrays_Efficiency_Detail", new[] { "ActivityId" });
            ...
            DropIndex("dbo.Fields", new[] { "FieldRoleId" });
            DropIndex("dbo.Fields", new[] { "DatastoreId" });
            ...
            DropTable("dbo.NPT_Sturgeon_Header");
            DropTable("dbo.NPT_Sturgeon_Detail");
            ...
            DropTable("dbo.Arrays_Efficiency_Header");
            DropTable("dbo.Arrays_Efficiency_Detail");
            DropTable("dbo.Seasons");
            DropTable("dbo.PitagisDatas");
