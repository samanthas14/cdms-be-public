namespace services.Migrations
{
    ...
    public partial class AddP4DataToScrewTrap : DbMigration
    {
...
insert into #NewDatasetIds(id) values (1214), (1215), (1216), (1217)
...
SELECT
   ...
   Validation = NULL,
   DataType = 'string',
   PossibleValues = '{"""":"""",""SUNNY"":""Sunny"",""PARTLY CLOUDY"":""Partly Cloudy"",""CLOUDY"":""Cloudy"",""RAIN"":""Rain""}',
...
delete from dbo.DatasetFields where DatasetId in (1214, 1215, 1216, 1217)
  and DbColumnName in ('EventType', 'SecondPitTag', 'RacewayTransectTank', 'LifeStage', 'GeneticId',
  'CodedWireTag', 'BroodYear', 'MigrationYear', 'SizeOfCount', 'ScaleId', 'Containment', 'Weather')
delete from dbo.Fields where FieldCategoryId = 9 and DbColumnName in (
  'EventType', 'SecondPitTag', 'RacewayTransectTank', 'LifeStage', 'GeneticId', 'CodedWireTag',
  'BroodYear', 'MigrationYear', 'SizeOfCount', 'ScaleId', 'Containment', 'Weather'
  )
