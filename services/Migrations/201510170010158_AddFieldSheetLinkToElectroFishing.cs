...
namespace services.Migrations
{
    ...
    public partial class AddFieldSheetLinkToElectroFishing : DbMigration
    {
    ...
    /* 0 */   ("Electrofishing", new List<string> { "'Fieldsheet Link'", HEAD, "'FieldsheetLink'", "'string'", "'file'", "'Paper scan of the fieldsheet'", "NULL", "NULL", "15", @"NULL" } ),
        ...
        {
            AddColumn("dbo.Electrofishing_Header", "FieldsheetLink", c => c.String());
            Sql(GetAddFieldSql(0));
        }
        
        public override void Down()
        {
            DropColumn("dbo.Electrofishing_Header", "FieldsheetLink");
