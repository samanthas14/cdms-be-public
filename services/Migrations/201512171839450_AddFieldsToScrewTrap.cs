namespace services.Migrations
{
    ...
    public partial class AddFieldsToScrewTrap : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.ScrewTrap_Header", "Turbidity", c => c.String());
            AddColumn("dbo.ScrewTrap_Header", "Crew", c => c.String());
            AddColumn("dbo.ScrewTrap_Header", "TrapStatus", c => c.String());
            DropColumn("dbo.ScrewTrap_Header", "Turbitity");
...
SELECT        Id, FileTitle, ClipFiles, Tagger, LivewellTemp, TaggingTemp, PostTaggingTemp, ReleaseTemp, ArrivalTime, DepartTime, ArrivalRPMs, DepartureRPMs, Hubometer, 
                         HubometerTime, TrapStopped, TrapStarted, FishCollected, FishReleased, Flow, Turbidity, TrapDebris, RiverDebris, ActivityComments, ActivityId, 
                         ByUserId, EffDt, Unit, DailyFinClips, Crew, TrapStatus
...
SELECT        h.FileTitle, h.ClipFiles, h.Tagger, h.LivewellTemp, h.TaggingTemp, h.PostTaggingTemp, h.ReleaseTemp, h.ArrivalTime, h.DepartTime, h.ArrivalRPMs, 
                         ...
                         h.ActivityComments, h.Unit, h.DailyFinClips, h.Crew, h.TrapStatus, d.Sequence, d.PitTagCode, d.ForkLength, d.Weight, d.OtherSpecies, d.FishCount, d.ConditionalComment, 
                         d.TextualComments, d.Note, d.ReleaseLocation, d.FishComments, d.RowId, d.RowStatusId, d.TagStatus, d.ClipStatus, d.AdditionalPositionalComments, 
...
go
        ...
        {
            AddColumn("dbo.ScrewTrap_Header", "Turbitity", c => c.String());
            DropColumn("dbo.ScrewTrap_Header", "TrapStatus");
            DropColumn("dbo.ScrewTrap_Header", "Crew");
            DropColumn("dbo.ScrewTrap_Header", "Turbidity");
...
AS
SELECT        Id, FileTitle, ClipFiles, Tagger, LivewellTemp, TaggingTemp, PostTaggingTemp, ReleaseTemp, ArrivalTime, DepartTime, ArrivalRPMs, DepartureRPMs, Hubometer, 
                         HubometerTime, TrapStopped, TrapStarted, FishCollected, FishReleased, Flow, Turbitity, TrapDebris, RiverDebris, ActivityComments, ActivityId, 
                         ByUserId, EffDt, Unit, DailyFinClips
FROM            dbo.ScrewTrap_Header AS h
WHERE        (EffDt =
                             (SELECT        MAX(EffDt) AS MaxEffDt
                               FROM            dbo.ScrewTrap_Header AS hh
...
AS
SELECT        h.FileTitle, h.ClipFiles, h.Tagger, h.LivewellTemp, h.TaggingTemp, h.PostTaggingTemp, h.ReleaseTemp, h.ArrivalTime, h.DepartTime, h.ArrivalRPMs, 
                         h.DepartureRPMs, h.Hubometer, h.HubometerTime, h.TrapStopped, h.TrapStarted, h.FishCollected, h.FishReleased, h.Flow, h.Turbitity, h.TrapDebris, h.RiverDebris, 
                         h.ActivityComments, h.Unit, h.DailyFinClips, d.Sequence, d.PitTagCode, d.ForkLength, d.Weight, d.OtherSpecies, d.FishCount, d.ConditionalComment, 
                         d.TextualComments, d.Note, d.ReleaseLocation, d.FishComments, d.RowId, d.RowStatusId, d.TagStatus, d.ClipStatus, d.AdditionalPositionalComments, 
                         CASE WHEN SpeciesRunRearing IN ('00U', '25H', '25W', '3RH', '3RW', '7RW', '90U', 'A0W', 'D0W', 'ERU', 'G0W') 
                         THEN '' WHEN d .ForkLength < 100 THEN 'Small' WHEN d .ForkLength > 120 THEN 'Large' ELSE 'Medium' END AS SizeClass, 
                         CASE WHEN SpeciesRunRearing = '00U' THEN 'Unknown (fish not observed)' WHEN SpeciesRunRearing = '11H' THEN 'Hat. Spring Chinook' WHEN SpeciesRunRearing
