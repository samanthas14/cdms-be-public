...
namespace services.Migrations
{
    ...
    public partial class MoreFakeLocations : DbMigration
    {
        public override void Up()
        {
            Sql(GetUp("StreamNet_NOSA", 9999, 107));
            Sql(GetUp("StreamNet_SAR", 9999, 108));
        }


        public override void Down()
        {
            Sql(GetDown("StreamNet_NOSA", 9999, 107));
            Sql(GetDown("StreamNet_SAR", 9999, 108));
        }
