...
namespace services.Migrations
{
    ...
    public partial class AddMissingFieldForElectroFishing : DbMigration
    {
        private static readonly List<Tuple<string, List<string>>> vals = new List<Tuple<string, List<string>>> { 
                             
           //     Dataset                             Name                H/D   dbName                  dbType       CtrlType       Descr                   Units   Rule       Order    PossibleValues               
           new Tuple<string, List<string>>                                                      
/* 0 */        ("Electrofishing", new List<string>  { "'Total Length'",   DET,  "'TotalLength'",       "'double'",   "'number'",  "'Total length of fish'", "'mm'" , "NULL",     "425",      "NULL" } ),
