...
namespace services.Migrations
{
    ...
    public partial class AddMoreFieldsForStreamNetDefaults : DbMigration
    {
        ...
        /* 0 */   ("StreamNet_RperS", new List<string> { "'Publish'",      DET, "'Publish'",       "'string'", "'select'", "'Should value be made public?'",   "NULL", @"'{""DefaultValue"":""YES""}'", "500", @"'{""YES"":""Yes"", ""NO"":""No""}'" } ),
           new Tuple<string, List<string>>                                                                                                                                                                    
        /* 1 */   ("StreamNet_SAR", new List<string> { "'Publish'",        DET, "'Publish'",       "'string'", "'select'", "'Should value be made public?'",   "NULL", @"'{""DefaultValue"":""YES""}'", "500", @"'{""YES"":""Yes"", ""NO"":""No""}'" } ),
           new Tuple<string, List<string>>                                                                                                                                                                    
        /* 2 */   ("StreamNet_NOSA", new List<string> { "'Publish'",       DET, "'Publish'",       "'string'", "'select'", "'Should value be made public?'",    "NULL", @"'{""DefaultValue"":""YES""}'", "500", @"'{""YES"":""Yes"", ""NO"":""No""}'" } ),
           new Tuple<string, List<string>>                                                                                                                                                                                        
        /* 0 */   ("StreamNet_RperS", new List<string> { "'SubmitAgency'", DET, "'SubmitAgency'",  "'string'",  "'select'", "'Agency'",             "NULL", @"'{""DefaultValue"":""CTUIR""}'", "510", @"'[""CTUIR""]'" } ),
           new Tuple<string, List<string>>                                                                                                                                                                   
        /* 1 */   ("StreamNet_SAR", new List<string>  { "'SubmitAgency'",   DET, "'SubmitAgency'",  "'string'", "'select'", "'Agency'",             "NULL", @"'{""DefaultValue"":""CTUIR""}'", "510", @"'[""CTUIR""]'" } ),
           new Tuple<string, List<string>>                                                                                                                                                                   
        /* 2 */   ("StreamNet_NOSA", new List<string> { "'SubmitAgency'",  DET, "'SubmitAgency'",  "'string'", "'select'", "'Agency'",               "NULL", @"'{""DefaultValue"":""CTUIR""}'", "510", @"'[""CTUIR""]'" } ),
