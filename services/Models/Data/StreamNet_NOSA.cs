...
{
    public class StreamNet_NOSA : DatasetData
    {
        public Dataset Dataset { get; set; }
        public StreamNet_NOSA_Header Header { get; set; }
        public List<StreamNet_NOSA_Detail> Details { get; set; }

        public StreamNet_NOSA()
        {
        ...
        public StreamNet_NOSA(int ActivityId)
        {
